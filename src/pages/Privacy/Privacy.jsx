...
const Privacy = () => {
  return (
    <div className="bg-gray-50 min-h-screen py-16 px-6 lg:px-20 font-plein">
      <motion.div
      ...
      >
        ...
        <div className="space-y-5 text-gray-700 leading-relaxed">
          ...
          <section>
            <p>
              At <span className="font-semibold">NTNL Construction Private Limited</span>
              (“Company,” “we,” “our,” or “us”), your privacy is important to us.
              This Privacy Policy explains how we collect, use, and protect any
              personal information that you provide when you visit or use our{" "}
              <a
            ...
            <p className="mt-4">
              We are committed to ensuring that your information is safe and that
              you feel confident when sharing details with us. By using our
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                email address, or company name) through inquiry forms or by email.
              </li>
              <li>
            ...
            <p className="mt-4">
              We do not knowingly collect sensitive personal information unless it
              is voluntarily provided by you for business purposes.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Maintaining communication regarding business relationships.</li>
          ...
          <section>
            ...
            <p>
              ...
              technical and organizational measures are in place to safeguard the
              information we collect. While we make every effort to protect your
              data, please note that no method of online transmission or storage
          ...
          <section>
            ...
            <p>
              Like many websites, we may use cookies or tracking tools to analyze
              Website traffic and improve user experience. Cookies are small files
              placed on your device to help us understand how visitors interact
              with our Website. You can accept or decline cookies through your
              browser settings. Declining cookies may limit some functionalities.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              by law. Once no longer needed, data will be securely deleted or
              anonymized.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              will be posted on this page, with a revised “Effective Date.” Please
          ...
          <section>
            ...
            <p>
              At NTNL Construction Private Limited, we value the trust you
              place in us. This Privacy Policy is our way of assuring you that
              your information is respected, protected, and used responsibly. We
              are dedicated to building not only strong infrastructure but also
