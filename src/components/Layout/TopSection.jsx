...
const TopSection = ({title,description}) => {
  return (
    <div className="top-section w-full h-[600px] flex gap-2 my-10 px-[10vw]">
      ...
      {/* right-section */}
      <div className="right-section w-[50%] h-full rounded-r-2xl">
        <img
          src="https://images.unsplash.com/photo-1694522362256-6c907336af43?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt=""
